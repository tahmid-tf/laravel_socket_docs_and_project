                ...
                <div class="card">
                   ...
                   <div class="card-body">
                       <div class="text-center">
                           <img src="{{ asset('img/circle.png') }}" alt="" id="circle" class="" style="height: 250px; width: 250px">
                       ...
                       <div class="text-center">
                           ...
                           <p class="font-weight-bold h5 text-danger" id="timer">Waiting to start</p>
                           <hr>
...
@push('scripts')
    <script>
        ...
        Echo.channel('game').listen('RemainingTimeChanged', function(e) {
